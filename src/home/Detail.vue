                                    ...
                                    <div class="col-md-6">
                                        <div class="product-gallery">
                                            <figure class="product-main-image">
                                                ...
                                                <img id="product-zoom"
                                                    src="frontend/assets/images/products/single/sidebar-gallery/1.jpg"
                                                    data-zoom-image="frontend/assets/images/products/single/sidebar-gallery/1-big.jpg"
                                                    alt="product image">
                                            ...
                                            <div id="product-zoom-gallery" class="product-image-gallery">
                                                <a class="product-gallery-item active" href="#"
                                                    data-image="frontend/assets/images/products/single/sidebar-gallery/1.jpg"
                                                    data-zoom-image="frontend/assets/images/products/single/sidebar-gallery/1-big.jpg">
                                                    <img src="frontend/assets/images/products/single/sidebar-gallery/1-small.jpg"
                                                        alt="product side">
                                                </a>

                                                <a class="product-gallery-item" href="#"
                                                    data-image="frontend/assets/images/products/single/sidebar-gallery/2.jpg"
                                                    data-zoom-image="frontend/assets/images/products/single/sidebar-gallery/2-big.jpg">
                                                    <img src="frontend/assets/images/products/single/sidebar-gallery/2-small.jpg"
                                                        alt="product cross">
                                                </a>

                                                <a class="product-gallery-item" href="#"
                                                    data-image="frontend/assets/images/products/single/sidebar-gallery/3.jpg"
                                                    data-zoom-image="frontend/assets/images/products/single/sidebar-gallery/3-big.jpg">
                                                    <img src="frontend/assets/images/products/single/sidebar-gallery/3-small.jpg"
                                                        alt="product with model">
                                                </a>

                                                <a class="product-gallery-item" href="#"
                                                    data-image="frontend/assets/images/products/single/sidebar-gallery/4.jpg"
                                                    data-zoom-image="frontend/assets/images/products/single/sidebar-gallery/4-big.jpg">
                                                    <img src="frontend/assets/images/products/single/sidebar-gallery/4-small.jpg"
                                                        alt="product back">
                                                </a>
                                    ...
                                    <div class="col-md-6">
                                        <div class="product-details product-details-sidebar">
                                            ...
                                            <div class="product-content">
                                                <p>Sed egestas, ante et vulputate volutpat, eros semper est, vitae
                                ...
                                <div class="widget widget-products">
                                    ...
                                    <div class="products">
                                        <div class="product product-sm">
                                            <figure class="product-media">
                                                <a href="product.html">
                                                    <img src="frontend/assets/images/products/single/sidebar/1.jpg"
                                        ...
                                        <div class="product product-sm">
                                            <figure class="product-media">
                                                <a href="product.html">
                                                    <img src="frontend/assets/images/products/single/sidebar/2.jpg"
                                                        alt="Product image" class="product-image">
                                                </a>
                                            </figure>
                                        ...
                                        <div class="product product-sm">
                                            <figure class="product-media">
                                                <a href="product.html">
                                                    <img src="frontend/assets/images/products/single/sidebar/3.jpg"
                                                        alt="Product image" class="product-image">
                                                </a>
                                            </figure>
                                        ...
                                        <div class="product product-sm">
                                            <figure class="product-media">
                                                <a href="product.html">
                                                    <img src="frontend/assets/images/products/single/sidebar/4.jpg"
                                                        alt="Product image" class="product-image">
                                                </a>
                                            </figure>
                                            ...
                                            <div class="product-body">
                                                <h5 class="product-title"><a href="product.html">Black soft RI weekend
                                                        travel bag</a></h5><!-- End .product-title -->
                                                <div class="product-price">
                                                    $75.00
                                                </div><!-- End .product-price -->
                                            </div><!-- End .product-body -->
                                    ...
                                    <a href="category.html" class="btn btn-outline-dark-3"><span>View More
