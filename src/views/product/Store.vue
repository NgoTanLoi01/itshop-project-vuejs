                                ...
                                <div class="row justify-content-center">
                                    <div class="col-6 col-md-4 col-lg-4">
                                        <div class="product product-7 text-center">
                                            <figure class="product-media">
                                                ...
                                                <a href="product.html">
                                                    <img src="frontend/assets/images/products/product-4.jpg" alt="Product image" class="product-image">
                                                </a>
                                            ...
                                            <div class="product-body">
                                                ...
                                                <div class="product-nav product-nav-thumbs">
                                                    <a href="#" class="active">
                                                        <img src="frontend/assets/images/products/product-4-thumb.jpg" alt="product desc">
                                                    </a>
                                                    <a href="#">
                                                        <img src="frontend/assets/images/products/product-4-2-thumb.jpg" alt="product desc">
                                                    </a>

                                                    <a href="#">
                                                        <img src="frontend/assets/images/products/product-4-3-thumb.jpg" alt="product desc">
                                                    </a>
                                                </div><!-- End .product-nav -->
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4">
                                        <div class="product product-7 text-center">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <div class="product-nav product-nav-thumbs">
                                                    <a href="#" class="active">
                                                        <img src="frontend/assets/images/products/product-5-thumb.jpg" alt="product desc">
                                                    </a>
                                                    <a href="#">
                                                        <img src="frontend/assets/images/products/product-5-2-thumb.jpg" alt="product desc">
                                                    </a>
                                                </div><!-- End .product-nav -->
                                            </div><!-- End .product-body -->
                                        </div><!-- End .product -->
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4">
                                        <div class="product product-7 text-center">
                                            <figure class="product-media">
                                                ...
                                                <a href="product.html">
                                                    <img src="frontend/assets/images/products/product-6.jpg" alt="Product image" class="product-image">
                                                </a>
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4">
                                        <div class="product product-7 text-center">
                                            <figure class="product-media">
                                                <a href="product.html">
                                                    <img src="frontend/assets/images/products/product-7.jpg" alt="Product image" class="product-image">
                                                </a>
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4">
                                        <div class="product product-7 text-center">
                                            <figure class="product-media">
                                                <span class="product-label label-new">New</span>
                                                <a href="product.html">
                                                    <img src="frontend/assets/images/products/product-8.jpg" alt="Product image" class="product-image">
                                                </a>
                                            ...
                                            <div class="product-body">
                                                ...
                                                <div class="product-nav product-nav-thumbs">
                                                    <a href="#" class="active">
                                                        <img src="frontend/assets/images/products/product-8-thumb.jpg" alt="product desc">
                                                    </a>
                                                    <a href="#">
                                                        <img src="frontend/assets/images/products/product-8-2-thumb.jpg" alt="product desc">
                                                    </a>
                                                </div><!-- End .product-nav -->
                                            </div><!-- End .product-body -->
                                        </div><!-- End .product -->
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4">
                                        <div class="product product-7 text-center">
                                            <figure class="product-media">
                                                <a href="product.html">
                                                    <img src="frontend/assets/images/products/product-9.jpg" alt="Product image" class="product-image">
                                                </a>
                                            ...
                                            <div class="product-body">
                                                ...
                                                <div class="product-nav product-nav-thumbs">
                                                    <a href="#" class="active">
                                                        <img src="frontend/assets/images/products/product-9-thumb.jpg" alt="product desc">
                                                    </a>
                                                    <a href="#">
                                                        <img src="frontend/assets/images/products/product-9-2-thumb.jpg" alt="product desc">
                                                    </a>
                                                    <a href="#">
                                                        <img src="frontend/assets/images/products/product-9-3-thumb.jpg" alt="product desc">
                                                    </a>
                                                </div><!-- End .product-nav -->
                                            </div><!-- End .product-body -->
                                        </div><!-- End .product -->
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4">
                                        <div class="product product-7 text-center">
                                            <figure class="product-media">
                                                ...
                                                <a href="product.html">
                                                    <img src="frontend/assets/images/products/product-11.jpg" alt="Product image" class="product-image">
                                                </a>
                                            ...
                                            <div class="product-body">
                                                ...
                                                <div class="product-nav product-nav-thumbs">
                                                    <a href="#" class="active">
                                                        <img src="frontend/assets/images/products/product-11-thumb.jpg" alt="product desc">
                                                    </a>
                                                    <a href="#">
                                                        <img src="frontend/assets/images/products/product-11-2-thumb.jpg" alt="product desc">
                                                    </a>

                                                    <a href="#">
                                                        <img src="frontend/assets/images/products/product-11-3-thumb.jpg" alt="product desc">
                                                    </a>
                                                </div><!-- End .product-nav -->
                                            </div><!-- End .product-body -->
                                        </div><!-- End .product -->
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4">
                                        <div class="product product-7 text-center">
                                            <figure class="product-media">
                                                <a href="product.html">
                                                    <img src="frontend/assets/images/products/product-10.jpg" alt="Product image" class="product-image">
                                                </a>
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4">
                                        <div class="product product-7 text-center">
                                            <figure class="product-media">
                                                <a href="product.html">
                                                    <img src="frontend/assets/images/products/product-12.jpg" alt="Product image" class="product-image">
                                                </a>
