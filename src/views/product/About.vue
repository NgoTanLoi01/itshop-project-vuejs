    ...
    <main class="main">
        ...
        <div class="container">
            <div class="page-header page-header-big text-center"
                style="background-image: url('frontend/assets/images/about-header-bg.jpg')">
                <h1 class="page-title text-white">Về chúng tôi</h1>
            </div><!-- End .page-header -->
        </div><!-- End .container -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <p>Sed egestas, ante et vulputate volutpat, eros pede semper est, vitae luctus metus libero eu
                            ...
                            <br>Praesent elementum hendrerit tortor. Sed semper lorem at felis. </p>
                    </div><!-- End .col-lg-6 -->
                </div><!-- End .row -->
