<template>
    <main class="main">
        <div class="page-header text-center" style="background-image: url('frontend/frontend/assets/images/page-header-bg.jpg')">
            <div class="container">
                <h1 class="page-title">Sản phẩm đã thích</h1>
            </div><!-- End .container -->
        </div><!-- End .page-header -->
                        ...
                        <tr>
                            <td class="product-col">
                                <div class="product">
                                    <figure class="product-media">
                                        <a href="#">
                                            <img src="frontend/assets/images/products/table/product-2.jpg" alt="Product image">
                                        </a>
                                    </figure>
                        ...
                        <tr>
                            <td class="product-col">
                                <div class="product">
                                    <figure class="product-media">
                                        <a href="#">
                                            <img src="frontend/assets/images/products/table/product-3.jpg" alt="Product image">
                                        </a>
                                    </figure>
